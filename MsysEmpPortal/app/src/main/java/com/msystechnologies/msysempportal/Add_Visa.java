...
public class Add_Visa extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add__visa);
        setTitle("Add Visa Detail");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.doc_clear:
                Intent home_intent = new Intent(this, Visa.class);
