...
//        setContentView(R.layout.activity_resource);
        ...
        //card list start
        CardListView card_list_View = (CardListView) this.findViewById(R.id.resource_cardlist);
        ...
        FloatingActionButton document_fab = (FloatingActionButton) findViewById(R.id.resource_fab);
        document_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fab_intent = new Intent(Resource.this,Add_Resource.class);
