...
//        setContentView(R.layout.activity_family);.
        ...
        View contentView = inflater.inflate(R.layout.activity_family, null, false);
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.addView(contentView, 0);

        //card list start
        CardListView card_list_View = (CardListView) this.findViewById(R.id.family_cardlist);
        ...
        FloatingActionButton document_fab = (FloatingActionButton) findViewById(R.id.family_fab);
        document_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fab_intent = new Intent(Family.this,Add_Family.class);
