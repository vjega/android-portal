...
public class FinanceTickets extends MainActivity {
...
//        setContentView(R.layout.activity_it_tickets);
        ...
        ListView list_View = (ListView) this.findViewById(R.id.finance_ticket_listView);
        ...
        FloatingActionButton document_fab = (FloatingActionButton) findViewById(R.id.finance_ticket_fab);
        document_fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent fab_intent = new Intent(FinanceTickets.this,Add_Document.class);
